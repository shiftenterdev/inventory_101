...
class SalesController extends Controller
{
    ...
    public function create(Request $request)
    {
        if ($request->invoice_no) {
            ...
            $invoice_no = self::SellInvoiceId();
            return redirect()->route('sales.create',"invoice_no=$invoice_no");
        }
    }
...
//        return view('admin.sell.print',compact('invoice'));
        $pdf = PDF::loadView('admin.sales.print', compact('invoice'));
        return $pdf->stream();
    }
    ...
    {
        $result = Sales::with('customer', 'products')->where('invoice_id', $sell_id)->first();
