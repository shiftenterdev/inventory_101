<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right">{{currency($t->quantity * ($t->price - $t->discount))}}</td>
        </tr>
    ...
    <tfooter>
        <tr>
            ...
            <td><input type="text" class="small form-control" value="{{currency($total)}}" readonly="readonly"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" class="small form-control select-text" name="tax_amount" value="{{currency($total*($invoice->tax/100))}}" readonly="readonly"></td>
        </tr>

        <tr>

            <td colspan="5" class="text-right">Grand Total :</td>
            <td colspan="1" class="text-right">{{currency($total-($invoice->other_discount)+($invoice->delivery_charge)+($total*($invoice->tax/100)))}}</td>
        </tr>
    </tfooter>
</table>
